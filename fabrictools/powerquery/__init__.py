...
* :class:`~fabrictools.powerquery.number.Number` — ``Number.FromText``
...
from fabrictools.powerquery._common import Int64, Order, Percentage, type
from fabrictools.powerquery.date import Date
