...
_EXPORT_REGISTRY = {
    ...
    "ifs_data_to_dataframe": ifs_data_to_dataframe,
    "ifs_request_json": ifs_request_json,
    "parse_ifs_data": parse_ifs_data,
    ...
    "write_ifs_data_to_lakehouse": write_ifs_data_to_lakehouse,
    "write_ifs_data_to_lakehouses": write_ifs_data_to_lakehouses,
    ...
    "metric_value_for_class": metric_value_for_class,
